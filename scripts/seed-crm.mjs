...
const platformSchema = new mongoose.Schema(
  { name: String, type: String, icon_slug: String, is_active: Boolean },
  { timestamps: true },
);
...
const TargetNiche =
  mongoose.models.TargetNiche || mongoose.model("TargetNiche", nicheSchema);
const CallScript =
  mongoose.models.CallScript || mongoose.model("CallScript", callScriptSchema);
const Permission =
...
// ─── Sample Call Script ───────────────────────────────────────────────────────
const scriptExists = await CallScript.findOne({
  title: "General Outreach Script",
});
if (!scriptExists) {
  await CallScript.create({
    title: "General Outreach Script",
    body_text: `Hi, this is [Your Name] from Camtask.
...
const PERMISSION_CATALOG = [
  ...
  {
    key: "leads.social.view.all",
    label: "View All Social Leads",
    module: "leads",
  },
  ...
  {
    key: "leads.dataentry.view",
    label: "View Own Data-Entry Leads",
    module: "leads",
  },
  {
    key: "leads.dataentry.view.all",
    label: "View All Data-Entry Leads",
    module: "leads",
  },
  {
    key: "leads.dataentry.create",
    label: "Create Data-Entry Leads",
    module: "leads",
  },
  {
    key: "leads.dataentry.edit",
    label: "Edit Data-Entry Leads",
    module: "leads",
  },
  {
    key: "leads.dataentry.delete",
    label: "Delete Data-Entry Leads",
    module: "leads",
  },
  { key: "leads.assign", label: "Assign Leads to Users", module: "leads" },
  { key: "leads.export", label: "Export Leads to CSV", module: "leads" },
  {
    key: "outreach.email.send",
...
const ROLES_DATA = [
  {
    ...
    permissionKeys: [
      ...
      "leads.social.create",
      "leads.social.edit",
      "leads.dataentry.view",
      "leads.dataentry.create",
      "leads.dataentry.edit",
      "outreach.email.send",
      "outreach.phone.log",
    ],
  },
  {
    ...
    permissionKeys: [
      "leads.social.view",
      "leads.social.view.all",
      "leads.social.create",
      "leads.social.edit",
      "leads.dataentry.view",
      "leads.dataentry.view.all",
      "leads.dataentry.create",
      "leads.dataentry.edit",
      "leads.assign",
      "leads.export",
...
console.log(
  "  3. Visit /admin/config to add Social ID Accounts, Sending Email Accounts, etc.",
);
